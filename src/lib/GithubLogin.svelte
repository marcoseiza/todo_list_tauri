...
<button
  on:click={onClick}
  class="bg-neutral-900 hover:bg-[rgb(26,26,26)] hover:scale-[1.01] transition-all text-gray-100 hover:text-white font-bold text-sm py-3 pl-4 pr-5 rounded flex justify-start items-center cursor-pointer mt-2 shadow"
>
  <svg
    viewBox="0 0 24 24"
  ...
  <span class="border-l border-gray-800 h-6 w-1 block mr-1" />
